...
const CHECK_DEFECTS = {
  ...
  accessClear: "під'їзд до гідранта не вільний (перешкоди в радіусі 5 м)",
  signPresent: 'відсутній покажчик місця розташування ПГ',
  signInfoComplete: 'покажчик не містить повної інформації (відстань, діаметр, тип мережі)',
  signLighting: 'немає освітлення для пошуку покажчика ПГ у нічний час',
  lidRed: 'кришку люка колодязя не пофарбовано в червоний колір / відсутня піраміда над кришкою',
  lidHandles: 'кришка люка не має втоплюваних ручок',
  lidInsulated: 'люк колодязя не утеплено на холодний період',
  wellNotFlooded: 'колодязь ПГ затоплений',
  groundingPresent: 'відсутній пристрій для заземлення пожежної техніки',
  groundingClean: 'заземлюючий пристрій не очищений від фарби / корозії',
  groundingMarked: 'місце заземлення не позначено спеціальним знаком',
  capPresent: 'відсутня кришка (ковпак) на ПГ',
  columnMounts: 'пожежна колонка не встановлюється на ПГ',
  opensEasily: 'ПГ не відкривається / шток відкручується із зусиллям',
  waterClean: 'вода з колонки при пуску візуально брудна',
  noWaterHammer: 'наявні гідроудари під час пуску води',
  pressureNorm: 'тиск у мережі не відповідає нормативним значенням',
  drainOk: 'несправний дренаж ПГ (стояк не звільняється від води)',
};
